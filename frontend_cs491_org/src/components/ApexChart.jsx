...
function useDefaultApexOptions() {
  useStyles()
...
function ApexChart({ options, ...rest }) {
  const defaultApexOptions = useDefaultApexOptions()
  const mergedOptions = mergeDeepRight(defaultApexOptions, options)

  return <ReactApexChart options={mergedOptions} {...rest} />
}
